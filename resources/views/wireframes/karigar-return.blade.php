...
<title>Receive Stock from Karigar — Radharani Jewellery Works</title>
<style>
...
<div style="width:1440px;max-width:100%;height:1080px;box-sizing:border-box;display:flex;background:#FAF8F4;overflow:hidden;margin:0 auto;">
  ...
  <div style="width:248px;min-width:248px;height:100%;background:#1C1815;display:flex;flex-direction:column;box-sizing:border-box;">
    ...
    <div style="padding:16px 12px;display:flex;flex-direction:column;gap:2px;">
      ...
      <a href="{{ route('wireframes.karigar-dispatch') }}" class="rj-navlink" style="display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:7px;background:#2A241E;color:#F5F1EA;font-size:13.5px;font-weight:600;">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#A9772F" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 3v2.2M12 18.8V21M4.9 7.4l1.9 1.1M17.2 15.5l1.9 1.1M4.9 16.6l1.9-1.1M17.2 8.5l1.9-1.1M3 12h2.2M18.8 12H21"/></svg>
        Karigar
      </a>
  ...
  <div style="flex-grow:1;min-width:0;height:100%;display:flex;flex-direction:column;box-sizing:border-box;">
    <div style="height:66px;min-height:66px;border-bottom:1px solid #E7E0D4;display:flex;align-items:center;justify-content:space-between;padding:0 32px;box-sizing:border-box;background:#FFFFFF;">
      <div style="display:flex;align-items:center;gap:12px;">
        <a href="{{ route('wireframes.karigar-dispatch') }}" style="width:32px;height:32px;border-radius:8px;border:1px solid #E7E0D4;display:flex;align-items:center;justify-content:center;">
        ...
        <div class="rj-serif" style="font-size:21px;color:#211D19;">Receive Stock from Karigar</div>
      </div>
      <div style="display:flex;align-items:center;gap:8px;background:#F3EFE8;border-radius:8px;padding:8px 14px;">
        <span style="font-size:13px;color:#211D19;font-weight:700;">KARIGAR</span>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#3F6B4A" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h14M13 6l6 6-6 6"/></svg>
    ...
    <div style="flex-grow:1;overflow:auto;padding:26px 32px;box-sizing:border-box;display:flex;gap:22px;">
      ...
      <!-- LEFT -->
      <div style="width:420px;flex-shrink:0;display:flex;flex-direction:column;gap:16px;">
        <div class="rj-card" style="padding:20px;box-sizing:border-box;">
          <div style="font-size:11px;color:#9A8F80;text-transform:uppercase;letter-spacing:0.05em;">Karigar</div>
          <div class="rj-serif" style="font-size:19px;color:#211D19;margin-top:3px;">Ramesh Kumar</div>
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-top:16px;padding-top:14px;border-top:1px solid #F3EFE8;">
            <div><div style="font-size:11px;color:#9A8F80;">Dispatch Date</div><div style="font-size:13px;color:#211D19;font-weight:600;margin-top:2px;">17 Sep 2026</div></div>
            <div><div style="font-size:11px;color:#9A8F80;">Expected Return</div><div style="font-size:13px;color:#211D19;font-weight:600;margin-top:2px;">20 Sep 2026</div></div>
            <div><div style="font-size:11px;color:#9A8F80;">Purpose</div><div style="font-size:13px;color:#211D19;font-weight:600;margin-top:2px;">Repair</div></div>
            <div><div style="font-size:11px;color:#9A8F80;">Items</div><div style="font-size:13px;color:#211D19;font-weight:600;margin-top:2px;">3</div></div>
          </div>
        </div>

        <div class="rj-card" style="padding:20px;box-sizing:border-box;flex-grow:1;">
          <div style="font-size:14px;font-weight:700;color:#211D19;margin-bottom:12px;">Items Being Returned</div>
          <div style="padding:14px 0;border-top:1px solid #F3EFE8;">
            <div style="display:flex;align-items:center;gap:12px;">
              <div style="width:22px;height:22px;border-radius:6px;background:#E4EDE3;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#3F6B4A" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12l5 5 11-11"/></svg>
              </div>
              <div style="flex-grow:1;">
                <div style="font-size:12.5px;color:#A9772F;font-weight:700;">RJ-G-10234</div>
                <div style="font-size:12px;color:#55504A;">Gold Ring · 5.82g</div>
              </div>
              <span style="font-size:11px;font-weight:700;padding:4px 10px;border-radius:20px;background:#E4EDE3;color:#3F6B4A;">Good</span>
            </div>
            <div style="font-size:11.5px;color:#9A8F80;margin-top:6px;margin-left:34px;">Sizing complete, ready for counter.</div>
          </div>
          <div style="padding:14px 0;border-top:1px solid #F3EFE8;">
            <div style="display:flex;align-items:center;gap:12px;">
              <div style="width:22px;height:22px;border-radius:6px;background:#E4EDE3;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
              ...
              <div style="flex-grow:1;">
                ...
                <div style="font-size:12px;color:#55504A;">Gold Chain · 18.40g</div>
              </div>
              <span style="font-size:11px;font-weight:700;padding:4px 10px;border-radius:20px;background:#E4EDE3;color:#3F6B4A;">Good</span>
            </div>
            <div style="font-size:11.5px;color:#9A8F80;margin-top:6px;margin-left:34px;">Clasp repaired and tested.</div>
          </div>
          <div style="padding:14px 0;border-top:1px solid #F3EFE8;">
            <div style="display:flex;align-items:center;gap:12px;">
              <div style="width:22px;height:22px;border-radius:6px;background:#E4EDE3;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
              ...
              <div style="flex-grow:1;">
                ...
                <div style="font-size:12px;color:#55504A;">Gold Bangle · 12.10g</div>
              </div>
              <span style="font-size:11px;font-weight:700;padding:4px 10px;border-radius:20px;background:#F5E9D2;color:#96631B;">Needs Polish</span>
            </div>
            <div style="font-size:11.5px;color:#9A8F80;margin-top:6px;margin-left:34px;">Minor scratch near clasp — route to polishing.</div>
          </div>
        </div>
      </div>
      ...
      <div class="rj-card" style="flex-grow:1;padding:26px 30px;box-sizing:border-box;overflow:auto;">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:18px 22px;">
          <div>
            <span class="rj-label">Received By</span>
          ...
          <div>
            <span class="rj-label">Return Date &amp; Time</span>
            <div class="rj-input" style="display:flex;align-items:center;gap:9px;">
              ...
              <span>20 Sep 2026, 5:30 PM</span>
            </div>
          </div>
        </div>

        <div style="margin-top:20px;">
          <span class="rj-label">Overall Remarks</span>
          <div class="rj-input" style="min-height:56px;color:#9A8F80;">2 pieces returned in good condition. RJ-G-10256 needs a final polish before it goes back to counter.</div>
        </div>

        <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:20px;">
          <div style="border:1.5px dashed #D8CEBC;border-radius:10px;padding:22px 16px;text-align:center;background:#FAF8F4;">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#A9772F" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" style="margin:0 auto 8px;display:block;"><rect x="3" y="6" width="18" height="14" rx="2"/><path d="M8 6l1.4-2.3h5.2L16 6"/><circle cx="12" cy="13" r="3.4"/></svg>
            <div style="font-size:12.5px;font-weight:700;color:#211D19;">Upload Return Photo</div>
            <div style="font-size:11px;color:#9A8F80;margin-top:3px;">Confirms condition on return</div>
          </div>
          <div style="border:1.5px dashed #D8CEBC;border-radius:10px;padding:22px 16px;text-align:center;background:#FAF8F4;">
            ...
            <div style="font-size:12.5px;font-weight:700;color:#211D19;">Upload Bill / Document</div>
            <div style="font-size:11px;color:#9A8F80;margin-top:3px;">Karigar's return bill, optional</div>
          </div>
        </div>

        <div style="margin-top:24px;padding-top:18px;border-top:1px solid #F3EFE8;display:flex;align-items:center;gap:10px;background:#FBF3E6;border-radius:10px;padding:14px 16px;">
          <span style="font-size:12.5px;color:#211D19;">This will record:</span>
          <span style="font-size:12.5px;font-weight:700;color:#8A5F22;">Karigar → Vault</span>
          <span style="font-size:12.5px;color:#8B7F6F;">for 3 items</span>
        </div>
        ...
        <div style="display:flex;align-items:center;justify-content:flex-end;gap:12px;margin-top:22px;">
          ...
          <button type="button" style="padding:12px 26px;border-radius:8px;border:none;background:#A9772F;color:#FFF7EC;font-size:13.5px;font-weight:700;">Confirm Return</button>
        </div>
      </div>
    </div>
  </div>
