...
<title>Send Stock to Karigar — Radharani Jewellery Works</title>
<style>
  ...
  <div style="flex-grow:1;min-width:0;height:100%;display:flex;flex-direction:column;box-sizing:border-box;">
    <div style="height:66px;min-height:66px;border-bottom:1px solid #E7E0D4;display:flex;align-items:center;justify-content:space-between;padding:0 32px;box-sizing:border-box;background:#FFFFFF;">
      <div style="display:flex;align-items:center;gap:12px;">
        ...
        <div class="rj-serif" style="font-size:21px;color:#211D19;">Send Stock to Karigar</div>
      </div>
    ...
    <div style="flex-grow:1;overflow:auto;padding:26px 32px;box-sizing:border-box;display:flex;gap:22px;">
      ...
      <div style="width:400px;flex-shrink:0;">
        <div class="rj-card" style="padding:20px;box-sizing:border-box;">
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;">
            <div style="font-size:14px;font-weight:700;color:#211D19;">Selected Items</div>
            <span style="font-size:11px;font-weight:700;padding:4px 10px;border-radius:20px;background:#F5E9D2;color:#96631B;">3 items</span>
          </div>
          <div style="display:flex;align-items:center;gap:12px;padding:12px 0;border-top:1px solid #F3EFE8;">
            <div style="width:38px;height:38px;border-radius:8px;background:#F3EFE8;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
              <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#B8AE9E" stroke-width="1.5"><circle cx="12" cy="14" r="6.2"/><path d="M8.6 8.2 10 4h4l1.4 4.2"/></svg>
            </div>
            <div style="flex-grow:1;min-width:0;">
              <div style="font-size:12.5px;color:#A9772F;font-weight:700;">RJ-G-10234</div>
              <div style="font-size:12.5px;color:#55504A;">Gold Ring · 5.82g</div>
            </div>
            <button type="button" style="width:26px;height:26px;border-radius:7px;border:1px solid #E7E0D4;background:#fff;display:flex;align-items:center;justify-content:center;">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#9A8F80" stroke-width="2" stroke-linecap="round"><path d="M6 6l12 12M18 6L6 18"/></svg>
            </button>
          </div>
          <div style="display:flex;align-items:center;gap:12px;padding:12px 0;border-top:1px solid #F3EFE8;">
            <div style="width:38px;height:38px;border-radius:8px;background:#F3EFE8;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
            ...
            <div style="flex-grow:1;min-width:0;">
              ...
              <div style="font-size:12.5px;color:#55504A;">Gold Chain · 18.40g</div>
            </div>
            <button type="button" style="width:26px;height:26px;border-radius:7px;border:1px solid #E7E0D4;background:#fff;display:flex;align-items:center;justify-content:center;">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#9A8F80" stroke-width="2" stroke-linecap="round"><path d="M6 6l12 12M18 6L6 18"/></svg>
            </button>
          ...
          <div style="display:flex;align-items:center;gap:12px;padding:12px 0;border-top:1px solid #F3EFE8;">
            ...
            <div style="flex-grow:1;min-width:0;">
              ...
              <div style="font-size:12.5px;color:#55504A;">Gold Bangle · 12.10g</div>
            </div>
            <button type="button" style="width:26px;height:26px;border-radius:7px;border:1px solid #E7E0D4;background:#fff;display:flex;align-items:center;justify-content:center;">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#9A8F80" stroke-width="2" stroke-linecap="round"><path d="M6 6l12 12M18 6L6 18"/></svg>
            </button>
          </div>
          <button type="button" style="width:100%;margin-top:12px;padding:10px;border-radius:8px;border:1px dashed #D8CEBC;background:#FAF8F4;color:#8A5F22;font-size:12.5px;font-weight:600;display:flex;align-items:center;justify-content:center;gap:6px;">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8A5F22" stroke-width="2" stroke-linecap="round"><path d="M12 5v14M5 12h14"/></svg>
            Scan more items
          </button>
        </div>

        <div class="rj-card" style="padding:18px 20px;margin-top:16px;box-sizing:border-box;">
          <div style="font-size:12.5px;font-weight:700;color:#211D19;margin-bottom:8px;">Total Weight Dispatched</div>
          <div class="rj-serif" style="font-size:26px;color:#211D19;">36.32g</div>
          <div style="font-size:11.5px;color:#9A8F80;margin-top:2px;">Gold 22K, 3 pieces</div>
        </div>
      </div>
      ...
      <div class="rj-card" style="flex-grow:1;padding:26px 30px;box-sizing:border-box;overflow:auto;">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:18px 22px;">
          <div>
            <span class="rj-label">Karigar</span>
          ...
          <div>
            <span class="rj-label">Issued By</span>
            <div class="rj-input" style="display:flex;align-items:center;justify-content:space-between;">
              <span>Amit Shah</span>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#9A8F80" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
            </div>
        ...
        <div style="margin-top:20px;">
          <span class="rj-label">Purpose</span>
          <div style="display:flex;gap:9px;flex-wrap:wrap;">
            <span style="padding:9px 16px;border-radius:20px;background:#FBF3E6;border:1.5px solid #A9772F;color:#8A5F22;font-size:12.5px;font-weight:700;">Repair</span>
            <span style="padding:9px 16px;border-radius:20px;background:#fff;border:1px solid #E7E0D4;color:#55504A;font-size:12.5px;">Resizing</span>
            <span style="padding:9px 16px;border-radius:20px;background:#fff;border:1px solid #E7E0D4;color:#55504A;font-size:12.5px;">Polishing</span>
            <span style="padding:9px 16px;border-radius:20px;background:#fff;border:1px solid #E7E0D4;color:#55504A;font-size:12.5px;">Stone Setting</span>
            <span style="padding:9px 16px;border-radius:20px;background:#fff;border:1px solid #E7E0D4;color:#55504A;font-size:12.5px;">Other</span>
          </div>
        </div>
        ...
        <div style="margin-top:20px;">
          ...
          <div class="rj-input" style="min-height:60px;color:#9A8F80;">Ring sizing from 14 to 16, customer request — Mrs. Verma</div>
        </div>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:22px;">
          <div style="border:1.5px dashed #D8CEBC;border-radius:10px;padding:22px 16px;text-align:center;background:#FAF8F4;">
            ...
            <div style="font-size:12.5px;font-weight:700;color:#211D19;">Upload Dispatch Photo</div>
            <div style="font-size:11px;color:#9A8F80;margin-top:3px;">Items photographed before hand-off</div>
          </div>
          <div style="border:1.5px dashed #D8CEBC;border-radius:10px;padding:22px 16px;text-align:center;background:#FAF8F4;">
            ...
            <div style="font-size:11px;color:#9A8F80;margin-top:3px;">Karigar challan or bill, optional</div>
          </div>
        </div>

        <div style="display:flex;align-items:center;justify-content:flex-end;gap:12px;margin-top:26px;padding-top:20px;border-top:1px solid #F3EFE8;">
